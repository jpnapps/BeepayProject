package com.cardstream.payment;
...
public class GatewayUnitTest {
	...
	private final Gateway cardstreamDirect = new Gateway("https://gateway.cardstream.com/direct/", "100001", "Circle4Take40Idea");
	private final Gateway cardstreamHosted = new Gateway("https://gateway.cardstream.com/hosted/", "100001", "Circle4Take40Idea");
	...
	public void direct_request() throws Exception {
		...
		request.put("customerName", "Cardstream");
		request.put("customerPhone", "+44 (0) 8450099575");
		request.put("customerPostCode", "17T ST8");
		request.put("type", "1"); // E-commerce

		final Map<String, String> response = this.cardstreamDirect.directRequest(request);
	...
	public void hosted_request() throws Exception {
		...
		final String html = this.cardstreamHosted.hostedRequest(request, options);

		assertEquals(html, "<form method=\"post\"  action=\"https://gateway.cardstream.com/hosted/\">\n"
